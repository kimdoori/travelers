		...
		<form action="modify.jsp" method="get">
			...
			<div class="form-group">
				<input class="form-control" name="phone" type="tel"
					...
					value="<%=corn.getPhone()%>" /> <label class="form-label">Phone</label>
			</div>
