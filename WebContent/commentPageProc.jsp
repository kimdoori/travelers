		...
		<div class="profile-user-page card">
			<div class="user-profile-data">
				...
				<div class="pop">
					...
					<div class="comment">
						<%
							if (isLogin && (user_id.equals(comment.getCorn_id()) || user_id.equals(pop.getCorn_id()))) {
						%>
						<a
							href="deleteComment.jsp?pop_id=<%=pop.getId()%>&id=<%=comment.getId()%>"><span
